...
export default function SPDashboard() {
  ...
  const [stats, setStats] = useState<SPDashboardStats | null>(null);
  ...
  const fetchStats = async () => {
    try {
      setLoading(true);
      const response = await fetch("/api/sp/dashboard-stats");
      if (response.ok) {
    ...
    <div className="max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-300">
          Welcome back, {session?.user?.name || "Service Provider"}
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-gray-900 rounded-lg shadow p-6 border border-gray-700">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-300">My Treks</p>
              <p className="text-2xl font-semibold text-white">
                {stats.treks.total}
              </p>
              <p className="text-xs text-gray-400">
